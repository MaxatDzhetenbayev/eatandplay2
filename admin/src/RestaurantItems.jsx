...
const RestaurantItems = () => {
  ...
  useEffect(() => {
    const fetchRestaurants = async () => {
      try {
        const response = await fetch('https://eatandplay2.onrender.com/restaurants');
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchDishes = async () => {
      try {
        const response = await fetch('https://eatandplay2.onrender.com/dishes');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchPreferences = async () => {
      try {
        const response = await fetch('https://eatandplay2.onrender.com/preference');
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
  ...
  const deleteRestaurant = async (id) => {
    try {
      const response = await fetch(`https://eatandplay2.onrender.com/restaurants/${id}`, {
        method: 'DELETE',
      });
      if (!response.ok) {
        throw new Error('Network response was not ok');
  ...
  const deleteDish = async () => {
    ...
    try {
      const response = await fetch(`https://eatandplay2.onrender.com/restaurants/${selectedDishForDeletion.restaurantId}/dishes/${selectedDishForDeletion.dishId}`, {
        method: 'DELETE',
      });
      if (!response.ok) {
        throw new Error('Network response was not ok');
      }
      const updatedRestaurants = await fetch('https://eatandplay2.onrender.com/restaurants').then(res => res.json());
  ...
  const handleAddDish = async (event, restaurantId) => {
    ...
    try {
      const response = await fetch(`https://eatandplay2.onrender.com/restaurants/${restaurantId}/dishes`, {
        method: 'POST',
        headers: {
  ...
  const handleAddPreference = async (event, restaurantId) => {
    event.preventDefault();
    try {
      const response = await fetch(`https://eatandplay2.onrender.com/restaurants/${restaurantId}/preferences`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const deletePreference = async () => {
    ...
    try {
      const response = await fetch(`https://eatandplay2.onrender.com/restaurants/${selectedPreferenceForDeletion.restaurantId}/preferences/${selectedPreferenceForDeletion.preferenceId}`, {
        method: 'DELETE',
      });
      if (!response.ok) {
        throw new Error('Network response was not ok');
